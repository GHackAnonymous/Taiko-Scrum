...
public class Instruction {
   ...
   public Instruction() {
       ...
       spanishInstruction = "El objetivo de este juego es pulsar la flecha "
               + "correspondiente cuando las notas de m√∫sica llegan abajo de "
               + "la pantalla y est√°n alineados con la marca circular. "
               + "Dependiendo por que lado llegue la nota tendr√°s que pulsar "
       ...
       italianInstruction = "L'obiettivo di questo gioco Ë premere il tasto "
